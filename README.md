...
│&nbsp;&nbsp└── version*/ # Imágenes de ejemplo<br>
│&nbsp;&nbsp│   &nbsp;&nbsp   ├── *.ipynb # Jupiter Notebooks con el codigo de los modelos entrenados<br>
└──&nbsp;&nbsp└──  &nbsp;&nbsp  └── *.pth # Pesos preentrenados de los modelos<br>
